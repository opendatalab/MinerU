...
MESSAGES: dict[str, tuple[str, str]] = {
    ...
    "tier_flash": ("flash", "flash（极速）"),
    "tier_basic": ("basic (medium)", "basic（中）"),
    "tier_standard": ("standard (high)", "standard（高）"),
    "tier_advanced": ("advanced (xhigh)", "advanced（极高）"),
