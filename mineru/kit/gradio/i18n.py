...
MESSAGES: dict[str, tuple[str, str]] = {
    ...
    "office_pending": ("Office results will be available after conversion", "Office 文件将在转换后提供结果"),
    ...
    "office_completed": ("{name} has been parsed", "{name} 已完成解析"),
    "office_notice": (
        "Office preview uses an external service. Conversion results do not depend on this preview.",
        "Office 在线预览依赖外部服务，转换结果不依赖该预览。",
    ),
    "ignore_once": ("Dismiss", "忽略"),
    "ignore_forever": ("Don't show again", "不再提示"),
