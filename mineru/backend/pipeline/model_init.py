...
from ...model.table.table_cls import TableClsModel
from ...model.table.img_orientation_cls import ImgOrientationClsModel
from ...model.table.unet_table import UnetTableModel
from ...utils.enum_class import ModelPath
from ...utils.models_download_utils import auto_download_and_get_model_root_path


def img_orientation_cls_model_init(lang=None):
    atom_model_manager = AtomModelSingleton()
    ocr_engine = atom_model_manager.get_atom_model(
        atom_model_name="ocr", det_db_box_thresh=0.5, det_db_unclip_ratio=1.6, lang=lang
    )
    cls_model = ImgOrientationClsModel(ocr_engine)
    return cls_model
...
class AtomModelSingleton:
    ...
    def get_atom_model(self, atom_model_name: str, **kwargs):
        ...
        elif atom_model_name in [AtomicModel.WirelessTable]:
