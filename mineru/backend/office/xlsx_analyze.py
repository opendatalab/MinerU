...
def office_xlsx_analyze(file_bytes: bytes, image_cache: ImagePayloadCache | None = None) -> tuple[list[PageInfo], list[Any]]:
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Quick demo runner for office_xlsx_analyze")
    parser.add_argument(
        "xlsx",
        nargs="?",
