...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Quick demo runner for office_docx_analyze")
    parser.add_argument(
        "docx",
        nargs="?",
    ...
    parser.add_argument("--output-images", help="directory to write image outputs", default="./output_images")
