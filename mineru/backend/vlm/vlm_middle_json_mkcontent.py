...
def _build_visual_body_segments(
    image_path: str, content: str, img_buket_path: str, span_type: str, summary_override: str = ""
) -> list[tuple[str, str]]:
    body_segments = []
...
def _render_visual_block_segments(
    block: Block, para_block: Block, img_buket_path: str = "", table_enable: bool = True
) -> list[tuple[str, str]]:
...
def mk_blocks_to_markdown(
    para_blocks: list[Block], make_mode: str, formula_enable: bool, table_enable: bool, img_buket_path: str = ""
) -> list[str]:
