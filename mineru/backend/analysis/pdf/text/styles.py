...
def build_pdf_native_visual_lines_and_styles(
    ...
    *,
    ...
    from docgale.analyzers.native.pdf.shared import build_native_line_items as _build_native_line_items
    from docgale.analyzers.native.pdf.shared import (
        merge_overlapping_inline_text_clusters as _merge_overlapping_inline_text_clusters,
    )
    from docgale.analyzers.native.pdf.shared import merge_same_baseline_text_lines as _merge_same_baseline_text_lines
