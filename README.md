...
# Changelog
- 2024/09/09 Version 0.8.0 released, supporting fast deployment with Dockerfile, providing [RAG](https://github.com/opendatalab/MinerU/blob/realese-0.8.0/projects/llama_index_rag/README.md) project example, and launching demos on Huggingface and Modelscope.
