...
This skill targets MinerU `>=4.0,<5` stable. Existing AMD and vendor adaptations remain on `<4`; use their version-specific guides rather than upgrading them with these commands.
