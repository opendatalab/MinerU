    ...
    setup(
        ...
        extras_require={
            "lite": ["paddleocr==2.7.3",
                     "paddlepaddle==3.0.0b1;platform_system=='Linux' or platform_system=='Darwin'",
            ...
            "full": ["unimernet==0.2.2",  # unimernet升级0.2.2,移除torchtext的依赖
                     ...
                     "paddlepaddle==3.0.0b1;platform_system=='Linux' or platform_system=='Darwin'",  # 解决linux的段异常问题
                     "paddlepaddle==2.6.1;platform_system=='Windows'",  # windows版本3.0.0b1效率下降，需锁定2.6.1
