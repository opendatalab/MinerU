...
```text
page:1/block:3
doc:ab12cd3/tier:basic/page:1/block:3
```
...
| `tier` | 实际解析档位: `flash` / `basic` / `standard` / `advanced`。 |
| `page_no` | 1-based 页号。 |
...
```json
{
  ...
  "block_ref": "doc:ab12cd3/tier:basic/page:1/block:3",
  "page": 1,
  "block": 3,
  "type": "paragraph"
}
...
```html
<!-- mineru:block {"ref":"doc:ab12cd3/tier:basic/page:1/block:3","locator":"page:1/block:3","type":"paragraph"} -->
```
...
```json
{
  "block_ref": "doc:ab12cd3/tier:basic/page:4/block:12",
