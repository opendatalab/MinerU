...
```http
GET /api/v1/docs/{sha256}/content?tier=standard&page_range=1~10&limit=30000
GET /api/v1/docs/{sha256}/content?tier=standard&page_range=7~10&after=doc:ab12cd3/tier:standard/page:7/block:4&limit=30000
GET /api/v1/docs/{sha256}/content?tier=standard&after=doc:ab12cd3/tier:standard/page:1/block:42&limit=30000
```
...
```http
GET /api/v1/docs/{sha}/content?tier=standard&after=doc:ab12cd3/tier:standard/page:21
```
...
```json
{
  "request_scope": {
    "page_range": "21~30",
    "after": "doc:ab12cd3/tier:standard/page:21",
    "limit": 30000
  }
}
```
  ...
  "content_ranges": [
    {
      ...
      "end": "doc:ab12cd3/tier:standard/page:10"
    }
  ]
}
```
  ...
  "content_ranges": [
    {
      "page_range": "1~5",
      "start": "doc:ab12cd3/tier:standard/page:1",
      "end": "doc:ab12cd3/tier:standard/page:5"
    },
    {
      "page_range": "20~25",
      "start": "doc:ab12cd3/tier:standard/page:20",
      "end": "doc:ab12cd3/tier:standard/page:25"
    }
  ]
}
```
...
```http
GET /api/v1/docs/{sha}/content?tier=standard&page_range=1~10&limit=30000
```
  ...
  "content_ranges": [
    {
      "page_range": "1~6",
      "start": "doc:ab12cd3/tier:standard/page:1",
      "end": "doc:ab12cd3/tier:standard/page:6"
    }
  ],
  "truncated": true,
  "next_request": {
...
```http
GET /api/v1/docs/{sha}/content?tier=standard&page_range=7~10&limit=30000
```
...
```json
{
  "content_ranges": [
    {
      "page_range": "7",
      "start": "doc:ab12cd3/tier:standard/page:7",
      "end": "doc:ab12cd3/tier:standard/page:7/block:4"
    }
  ],
  "truncated": true,
  "next_request": {
    "page_range": "7~10",
    "after": "doc:ab12cd3/tier:standard/page:7/block:4"
  }
}
```
...
```json
{
  "content_ranges": [
    {
      "page_range": "7",
      "start": "doc:ab12cd3/tier:standard/page:7/block:4/char:0",
      "end": "doc:ab12cd3/tier:standard/page:7/block:4/char:32784"
    }
  ],
  "truncated": true,
  "next_request": {
    "page_range": "7~10",
    "after": "doc:ab12cd3/tier:standard/page:7/block:4/char:32784"
  }
}
```
...
```http
GET /api/v1/docs/{sha}/content?tier=standard&page_range=1~5,20~25
```
...
```json
{
  ...
  "content_ranges": [
    {
      "page_range": null,
      "start": "doc:ab12cd3/tier:standard/page:1/block:1",
      "end": "doc:ab12cd3/tier:standard/page:1/block:42"
    }
  ],
  "truncated": true,
  "next_request": {
    "after": "doc:ab12cd3/tier:standard/page:1/block:42"
  }
}
```
...
```json
{
  "content_ranges": [
    {
      "page_range": null,
      "start": "doc:ab12cd3/tier:standard/page:1/block:1/char:0",
      "end": "doc:ab12cd3/tier:standard/page:1/block:1/char:32784"
    }
  ],
  "truncated": true,
  "next_request": {
    "after": "doc:ab12cd3/tier:standard/page:1/block:1/char:32784"
  }
}
```
...
```html
<!-- Next: mineru parse report.pdf --pages 7~10 --after doc:ab12cd3/tier:standard/page:7/block:4 -->
```

非分页文档:

```html
<!-- Next: mineru parse long.docx --after doc:ab12cd3/tier:standard/page:1/block:42 -->
```
