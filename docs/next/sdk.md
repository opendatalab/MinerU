...
- `mineru.doclib.client.DoclibClient`: 本地 doclib 的 Product SDK。
...
4. [Doclib Client](sdk/doclib-client.md): `DoclibClient` 的本地文档库能力。
...
- 其他语言 SDK 暂无开发计划；如果未来开发，只覆盖 v1 Unified API，不覆盖本地 doclib transport discovery 能力。
