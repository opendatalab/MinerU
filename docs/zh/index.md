...
MinerU 是一款文档解析工具，可将 `PDF`、`EPUB`、静态 `HTML`、图片、`CSV`、`RTF`、`DOCX`、`PPTX`、`XLSX`、`ODT`、`ODS`、`ODP` 转化为机器可读格式（如 Markdown、JSON），便于后续检索、抽取与二次处理。
...
- 支持 `PDF`、`EPUB`、静态 `HTML`、图片、`CSV`、`RTF`、`DOCX`、`PPTX`、`XLSX`、`ODT`、`ODS`、`ODP` 输入
